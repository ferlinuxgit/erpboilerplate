...
const destinations = [
  ...
  { href: "/sales/quotes", label: "Presupuestos de venta", group: "Navegación" },
  { href: "/sales/orders", label: "Pedidos de venta", group: "Navegación" },
  { href: "/sales/delivery-notes", label: "Albaranes de venta", group: "Navegación" },
